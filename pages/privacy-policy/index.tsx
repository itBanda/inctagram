...
const PrivacyPolicy = () => {
  return (
    <div className='mx-auto max-w-[1232px] px-4 py-6 text-center text-light-100 sm:px-6 lg:px-8'>
      ...
      <h1 className='py-6 text-xl font-bold'>Privacy Policy</h1>
      <p className='mx-auto max-w-[958px] cursor-default text-sm leading-6'>
        ...
        Massa enim nec dui nunc mattis enim ut tellus. Scelerisque eleifend donec pretium vulputate
        sapien nec sagittis. Feugiat nisl pretium fusce id velit ut tortor pretium viverra. Tortor
        aliquam nulla facilisi cras. Elit pellentesque habitant morbi tristique senectus et netus.
        Nulla facilisi nullam vehicula ipsum a arcu cursus. Ut lectus arcu bibendum at varius vel
        ...
        pharetra. Tincidunt lobortis feugiat vivamus at augue. Non odio euismod lacinia at. Aliquet
        eget sit amet tellus. Auctor neque vitae tempus quam.
        <br /> Tellus in hac habitasse platea dictumst vestibulum rhoncus est. Nisl pretium fusce id
        velit ut tortor pretium. Eget arcu dictum varius duis at consectetur. Est placerat in
        egestas erat imperdiet sed euismod nisi porta. Scelerisque felis imperdiet proin fermentum.
        Tellus in hac habitasse platea dictumst vestibulum rhoncus. Proin nibh nisl condimentum id
        venenatis a condimentum vitae. Massa tincidunt dui ut ornare lectus sit amet est placerat.
        Vel turpis nunc eget lorem dolor sed viverra ipsum. Enim ut tellus elementum sagittis. At
        consectetur lorem donec massa sapien faucibus et molestie. Enim sit amet venenatis urna
        cursus. Id velit ut tortor pretium viverra suspendisse potenti.
        <br /> Et magnis dis parturient montes nascetur ridiculus. Donec ultrices tincidunt arcu non
        ...
        netus et. A lacus vestibulum sed arcu non odio.
        <br /> Sed elementum tempus egestas sed. Faucibus et molestie ac feugiat sed lectus
        vestibulum mattis ullamcorper. Gravida rutrum quisque non tellus orci ac. Turpis tincidunt
        id aliquet risus feugiat in ante metus dictum. Dolor morbi non arcu risus quis varius quam
        quisque. Bibendum at varius vel pharetra vel turpis nunc. A cras semper auctor neque. Aenean
        vel elit scelerisque mauris pellentesque pulvinar pellentesque habitant. Erat nam at lectus
        urna duis. Mauris pharetra et ultrices neque. Nulla facilisi etiam dignissim diam quis enim
        ...
        <br /> A diam maecenas sed enim ut. Fermentum et sollicitudin ac orci phasellus. Tincidunt
        vitae semper quis lectus nulla. Tincidunt dui ut ornare lectus sit amet est. Sed enim ut sem
        ...
        <br /> Eu mi bibendum neque egestas congue quisque egestas diam in. Neque viverra justo nec
