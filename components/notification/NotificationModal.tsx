...
export const NotificationModal = ({ notifications }: Props) => {
  return (
    <div className='absolute -right-1 z-20 mt-3 w-[355px] rounded-lg border border-dark-100 bg-dark-500'>
      ...
      <h2 className='mx-4 border-b border-b-dark-100 py-3 text-base font-semibold text-light-100'>
        {notifications.length === 0 ? 'Нет новых уведомлений' : 'Уведомления'}
      </h2>
